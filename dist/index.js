...
define("@scom/scom-area-chart/interfaces.ts", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("@scom/scom-area-chart/dts/index.ts", ["require", "exports"], function (require, exports) {
    ...
    exports.default = `/// <amd-module name="@scom/scom-area-chart/interfaces.ts" />
declare module "@scom/scom-area-chart/interfaces.ts" {
...
declare module "@scom/scom-area-chart" {
    ...
    export default class ScomAreaChart extends ScomCharts<IAreaChartOptions> implements ICustomWidget {
        register(): {
            types: string;
            defaultData: IAreaChartConfig;
        };
...
define("@scom/scom-area-chart", ["require", "exports", "@ijstech/components", "@scom/scom-area-chart/data.json.ts", "@scom/scom-area-chart/formSchema.ts", "@scom/scom-area-chart/dts/index.ts", "@scom/scom-charts"], function (require, exports, components_1, data_json_1, formSchema_1, index_1, scom_charts_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let ScomAreaChart = class ScomAreaChart extends scom_charts_1.ScomCharts {
        register() {
    ...
    ScomAreaChart = __decorate([
        ...
        (0, components_1.customElements)('i-scom-area-chart', {
            icon: 'chart-area',
