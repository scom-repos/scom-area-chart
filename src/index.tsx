...
import { IAreaChartConfig, callAPI, formatNumber, groupByCategory, extractUniqueTimes, concatUnique, groupArrayByKey, formatNumberByFormat } from './global/index';
    ...
    const actions = [
      {
        ...
        command: (builder: any, userInputData: any) => {
          let _oldData: IAreaChartConfig = { apiEndpoint: '', options: undefined };
          return {
            execute: async () => {
              _oldData = {...this._data};
