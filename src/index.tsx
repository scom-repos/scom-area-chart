...
import { IAreaChartConfig, IAreaChartOptions } from './interfaces';
...
export default class ScomAreaChart extends ScomCharts<IAreaChartOptions> implements ICustomWidget {
  ...
  getChartData() {
    ...
    return { chartData: _chartData, defaulBuildertData: configData.defaultBuilderData as IAreaChartConfig };
  }
