...
import { IAreaChartConfig, callAPI, formatNumber, groupByCategory, extractUniqueTimes, concatUnique, groupArrayByKey, formatNumberByFormat, IAreaChartOptions, isNumeric } from './global/index';
...
const DefaultData: IAreaChartConfig = {
...
export default class ScomAreaChart extends Module {
  ...
  private _data: IAreaChartConfig = DefaultData;
  tag: any = {};
    ...
    const actions = [
      {
        ...
        command: (builder: any, userInputData: any) => {
          let oldData: IAreaChartConfig = DefaultData;
          let oldTag = {};
          return {
            execute: async () => {
              ...
              if (advancedSchema) {
                ...
                this._data = { ...generalSettings as IAreaChartConfig, options };
              }
      ...
      },
      {
        ...
        icon: 'database',
        command: (builder: any, userInputData: any) => {
          let _oldData: IAreaChartConfig = DefaultData;
          return {
            execute: async () => {
              _oldData = { ...this._data };
        ...
        customUI: {
          render: (data?: any, onConfirm?: (result: boolean, data: any) => void, onChange?: (result: boolean, data: any) => void) => {
            ...
            const dataOptionsForm = new ScomAreaChartDataOptionsForm(null, {
